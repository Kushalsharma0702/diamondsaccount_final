...
class FilesApi {
  ...
  /// Upload a file using multipart/form-data to POST /files/upload (for mobile/desktop with file path)
  ...
  /// This is required because file.path is unavailable on web
  /// Returns the decoded response map on success (201)
  static Future<Map<String, dynamic>> uploadFileFromBytes({
